...
import { getNotes, getNoteById, createNote, updateNote, deleteNote } from './note';
...
describe('note API', () => {
  ...
  describe('getNotes', () => {
    ...
    test('throws error when response is not ok', async () => {
      const errorMessage = { message: 'Not authorized' };
      mockFetch.mockResolvedValueOnce({
        ok: false,
        json: () => Promise.resolve(errorMessage)
      });

      await expect(getNotes(mockUserId)).rejects.toThrow();
    });
  });
  ...
  describe('getNoteById', () => {
    ...
    test('throws error when response is not ok', async () => {
      ...
      await expect(getNoteById(mockNoteId)).rejects.toThrow();
    });
  });
  ...
  describe('createNote', () => {
    ...
    test('throws error when response is not ok', async () => {
      ...
      await expect(createNote(newNote)).rejects.toThrow();
    });
  });
  ...
  describe('updateNote', () => {
    ...
    test('throws error when response is not ok', async () => {
      ...
      await expect(updateNote(mockNoteId, updatedNote)).rejects.toThrow();
    });
  });
  ...
  describe('deleteNote', () => {
    ...
    test('throws error when response is not ok', async () => {
      mockFetch.mockResolvedValueOnce({
        ok: false,
        json: () => Promise.resolve({ message: 'Not authorized to delete' })
      });

      await expect(deleteNote(mockNoteId)).rejects.toThrow();
    });
  });
});
